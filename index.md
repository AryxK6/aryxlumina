...
<div class="home-wrap">
  <div>
    <!-- HERO: Latest Post (Static Jekyll) -->
    ...
    <div class="hero-post" id="hero-post">
      <a class="hero-card" href="{{ hero.url }}">
        ...
        <div class="hero-body">
          ...
          <div class="hero-excerpt">{{ hero.excerpt | strip_html | truncate: 150 }}</div>
    ...
    <div id="pagination-wrap">
      <div class="load-wrap">
        <button class="load-btn" id="load-more-btn" onclick="loadMorePosts()"><span>Load More</span><span class="spinner"></span></button>
      </div>
    </div>
    {% endif %}
  </div>
