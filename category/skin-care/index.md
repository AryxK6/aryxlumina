...
layout: default
title: "Skin Care"
description: "Expert skin care guides, routines, and tips for healthy, glowing skin."
permalink: /category/skin-care
---
<style>
...
<div class="cat-page-hero">
  <div class="page-hero-tag" style="display:inline-block;background:var(--tag-bg);color:var(--neon);border:1px solid var(--border);padding:0.3rem 0.9rem;border-radius:20px;font-size:0.8rem;font-weight:600;letter-spacing:1px;text-transform:uppercase;margin-bottom:1rem;font-family:'DM Sans',sans-serif;">Category</div>
  <h1>🧴 <span>Skin Care</span></h1>
  <p>Expert guides, routines, and tips for healthy, glowing skin.</p>
</div>
<div class="sub-cats">
  <a class="sub-cat-link" href="/category/skin-care-routine">Skin Care Routine</a>
  <a class="sub-cat-link" href="/category/anti-aging">Anti-Aging</a>
  <a class="sub-cat-link" href="/category/acne-blemishes">Acne & Blemishes</a>
  <a class="sub-cat-link" href="/category/natural-skin-care">Natural Skin Care</a>
  <a class="sub-cat-link" href="/category/face-masks-serums">Face Masks & Serums</a>
</div>
